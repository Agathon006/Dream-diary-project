...
class View {
  ...
  translatePage() {
    fetch('./dictionary.json').then(response => response.json()).then(data => {
      ...
      document.querySelector(`#reasons-block-subtitle`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('home.reasons_block_subtitle');
      document.querySelector(`#reasons-block-fisrt-plot-title`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('home.reasons_block_first_plot_title');
      document.querySelector(`#reasons-block-fisrt-plot`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('home.reasons_block_fisrt_plot');
      document.querySelector(`#reasons-block-second-plot-title`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('home.reasons_block_second_plot_title');
      document.querySelector(`#reasons-block-second-plot`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('home.reasons_block_second_plot');
      document.querySelector(`#reasons-block-third-plot-title`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('home.reasons_block_third_plot_title');
      ...
      document.querySelector(`#do-not-have-dreams-block-second-section-plot`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('home.do_not_have_dreams_block_second_section_plot');
      document.querySelector(`#do-not-have-dreams-block-third-section-title`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('home.do_not_have_dreams_block_third_section_title');
      document.querySelector(`#do-not-have-dreams-block-third-section-plot`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('home.do_not_have_dreams_block_third_section_plot');
      document.querySelector(`#do-not-have-dreams-block-fourth-section-title`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('home.do_not_have_dreams_block_fourth_section_title');
      document.querySelector(`#do-not-have-dreams-block-fourth-section-plot`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('home.do_not_have_dreams_block_fourth_section_plot');
      document.querySelector(`#do-not-have-dreams-sections-button`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('home.do_not_have_dreams_sections_button');
      document.querySelector(`#start-using-block-title`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('home.start_using_block_title');
      document.querySelector(`#start-using-block-subtitle`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('home.start_using_block_subtitle');
      document.querySelector(`#start-using-block-link`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('home.start_using_block_link');
