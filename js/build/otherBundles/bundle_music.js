...
class View {
  translatePage() {
    fetch('../dictionary.json').then(response => response.json()).then(data => {
      ...
      document.querySelector(`#music-player-title`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('music.music_player_title');
...
(() => {
/*!*********************************!*\
  !*** ./js/pages/music/index.js ***!
  \*********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _view_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./view.js */ "./js/pages/music/view.js");
...
/******/ })()
;
//# sourceMappingURL=bundle_music.js.map