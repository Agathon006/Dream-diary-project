...
class View {
  ...
  translatePage() {
    fetch('../dictionary.json').then(response => response.json()).then(data => {
      ...
      document.querySelector(`#tokyo-span`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('time.tokyo_span');
      document.querySelector(`#berlin-span`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('time.berlin_span');
      document.querySelector(`#china-span`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('time.china_span');
      document.querySelector(`#sydney-span`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('time.sydney_span');
      document.querySelector(`#california-span`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('time.california_span');
      document.querySelector(`#india-span`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('time.india_span');
