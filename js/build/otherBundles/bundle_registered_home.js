...
class View {
  ...
  translatePage() {
    fetch('../dictionary.json').then(response => response.json()).then(data => {
      ...
      document.querySelector(`#header-link-home`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('registered_header.home');
      document.querySelector(`#header-link-time`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('registered_header.moon');
      document.querySelector(`#header-link-moon`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('registered_header.time');
      ...
      document.querySelector(`#notification`).innerHTML = `
                ...
                `;
      document.querySelector(`#filter-search-span`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('registered_home.filter_search_span');
      document.querySelector(`#filter-category-span`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('registered_home.filter_category_span');
      document.querySelector(`#filter-mood-span`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('registered_home.filter_moon_span');
      document.querySelector(`#filter-sort-span`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('registered_home.filter_sort_span');
      document.querySelector(`#dream-category-select`).options[0].textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('registered_home.dream_category_select_option_first');
      document.querySelector(`#dream-category-select`).options[1].textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('registered_home.dream_category_select_option_second');
      document.querySelector(`#dream-category-select`).options[2].textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('registered_home.dream_category_select_option_third');
      document.querySelector(`#dream-category-select`).options[3].textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('registered_home.dream_category_select_option_fourth');
      document.querySelector(`#dream-category-select`).options[4].textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('registered_home.dream_category_select_option_fifth');
      document.querySelector(`#dream-category-select`).options[5].textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('registered_home.dream_category_select_option_sixth');
      document.querySelector(`#dream-category-select`).options[6].textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('registered_home.dream_category_select_option_seventh');
      document.querySelector(`#dream-mood-select`).options[0].textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('registered_home.dream_mood_select_option_first');
      document.querySelector(`#dream-mood-select`).options[1].textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('registered_home.dream_mood_select_option_second');
      document.querySelector(`#dream-mood-select`).options[2].textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('registered_home.dream_mood_select_option_third');
      document.querySelector(`#dream-mood-select`).options[3].textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('registered_home.dream_mood_select_option_fourth');
      document.querySelector(`#dream-mood-select`).options[4].textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('registered_home.dream_mood_select_option_fifth');
      document.querySelector(`#dream-mood-select`).options[5].textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('registered_home.dream_mood_select_option_sixth');
      document.querySelector(`#dream-sort-select`).options[0].textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('registered_home.dream_sort_select_option_first');
      document.querySelector(`#dream-sort-select`).options[1].textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('registered_home.dream_sort_select_option_second');
      document.querySelector(`#dream-sort-select`).options[2].textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('registered_home.dream_sort_select_option_third');
      document.querySelector(`#share-dream-link`).textContent = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t('registered_home.share_dream_link');
